...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 3479791559009740702),
      name: 'Owner',
      lastPropertyId: const IdUid(2, 8244886603425194707),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 2782384293155418436),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 8244886603425194707),
            name: 'name',
            type: 9,
            flags: 0)
      ],
  ...
  ModelEntity(
      ...
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 5320827970843580291),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 8106586646148549133),
            name: 'text',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 3444867482014560401),
            name: 'status',
            type: 1,
            flags: 0),
        ModelProperty(
            id: const IdUid(4, 3349278380321026425),
            name: 'ownerId',
            type: 11,
            flags: 520,
